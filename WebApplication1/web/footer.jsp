<%-- 
    Document   : footer
    Created on : Nov 22, 2018, 11:02:37 AM
    Author     : unknown_HUST
--%>
            ...
            <div class="footer-top">
                <div class="wrap">
                    <div class="section group example">
                        ...
                        <div class="col_1_of_2 span_1_of_2">
                            <ul class="f-list">
                                <li><img src="images/3.png"><span class="f-text">Contact Us!Phone Number: 088888888</span>
                                    <div class="clear"></div>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div class="col_1_of_f_1 span_1_of_f_1">
                            <div class="section group example">
                                <div class="col_1_of_f_2 span_1_of_f_2">
                                    <h3>Information</h3>
                                    <ul class="f-list1">
                                        <li><a href="#">Hanoi University of Science and Technology </a></li>
                                ...
                                <div class="col_1_of_f_2 span_1_of_f_2">
                                    ...
                                    <div class="company_address">
                                        ...
                                        <p>Viet Nam</p>
                                        <p>Phone:088888888</p>
                                        <p>Fax: (000)66666666</p>
                                        <p>Email: <span>project2@gmail.com</span></p>
                                    ...
                                    <div class="social-media">
                                        <ul>
                                            ...
                                            <li><span class="simptip-position-bottom simptip-movable" data-tooltip="Linked in"><a
                                                        href="#" target="_blank">
                                                    </a> </span></li>
